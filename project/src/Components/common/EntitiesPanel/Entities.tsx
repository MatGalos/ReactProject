...
import PhotoDisplay from "./entitiesModule/photoDisplay";
...
import FilterByTitle from "./entitiesModule/filterByText";
import AllDiv from "./entitiesModule/allDiv";
import {CopyToClipboard} from 'react-copy-to-clipboard';
import Mosaic from "./entitiesModule/mosaic";
        ...
        return (
            <Wrapper isFullScreen={isFullScreen}>
                <SectionHolder>
                    ...
                    <Mosaic isMosaic={mosaicView} switchView={
                ...
                <SectionHolder>
                    ...
                    <SideSectionHolder>
                        <FilterByTitle filterVal={(val: string) => filterHandler(val)} />
                        <Followed myPostsOnly={(val: boolean) => myPostsHandler(val)}
                        header={myPostsOnly}/>
                    </SideSectionHolder>
                </SectionHolder>
                <PilesWrapper>
                    {filteredPhotos.sort(comparePhotos).map((photo, index) =>
                        <PhotoDisplay key={index} photoUrl={photo?.url} title={photo?.title} isMosaic={mosaicView}></PhotoDisplay>
                    )}
                </PilesWrapper>
            </Wrapper>
        )
